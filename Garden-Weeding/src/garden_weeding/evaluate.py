...
class evaluation:
    def evaluate(self, crypto_embeddings, non_crypto_embeddings, discarded_crypto_embeddings, REPRESENTATION, CLASSIFIER):
    ...
    def generate_html_report(self, crypto_embeddings, non_crypto_embeddings, discarded_crypto_embeddings, stats, REPRESENTATION, CLASSIFIER):
...
"""
        ...
        html_content = html_content.replace("__REPRESENTATION__", REPRESENTATION)
        html_content = html_content.replace("__CLASSIFIER__", CLASSIFIER)
